const About = () => {
  return (
    <section id="About" className="w-full min-h-screen bg-white flex items-center justify-center px-6 md:px-12">
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl gap-2">

        {/* Left: Text Section */}
        <div className="md:w-1/2 text-left text-slate-700 space-y-3 pl-12">
          <h1 className="text-4xl font-semibold text-slate-500">About Me</h1>

          <p className="text-lg text-slate-400 leading-7">
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative">
            {/* Extra border */}
            <div className="absolute -top-3 -left-3 w-72 h-96 border-t-4 border-l-4 border-slate-400 rounded-2xl z-0"></div>

            {/* Image */}
            <img
              src="/Profile.jpeg"
              alt="Paramesh"
              className="w-72 h-96 object-cover rounded-2xl shadow-lg border-2 border-slate-300 relative z-10"
            />
          </div>
        </div>
